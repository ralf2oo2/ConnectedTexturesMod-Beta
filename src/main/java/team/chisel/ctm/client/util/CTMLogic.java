...
public class CTMLogic {
     ...
     */
    public int[] createSubmapIndices(@Nullable BlockStateView world, BlockPos pos, Direction side) {
        if (world == null) {
            return submapCache;
        }
     ...
     */
    public void buildConnectionMap(BlockStateView world, BlockPos pos, Direction side) {
...
//        }
     ...
     */
    public final boolean isConnected(BlockStateView world, BlockPos current, BlockPos connection, Direction dir) {
...
//      }
        ...
        boolean disableObscured = disableObscuredFaceCheck.orElse(Config.CONFIG.connectInsideCTM);
...
//    }
    ...
    /**
     * @deprecated Use the instance method {@link CTMLogic#getConnectionState(BlockStateView, BlockPos, Direction, BlockPos)}
     */
    @Deprecated
    public static BlockState getBlockOrFacade(BlockStateView world, BlockPos pos, @Nullable Direction side, BlockPos connection) {
        return CTMLogic.getInstance().getConnectionState(world, pos, side, connection);
    }

    public BlockState getConnectionState(BlockStateView world, BlockPos pos, @Nullable Direction side, BlockPos connection) {
