...
public class ConnectionLogic {
     ...
     */
    public void buildConnectionMap(@NotNull BlockStateView world, @NotNull BlockPos pos, @NotNull Direction side) {
        connectionMap = 0;
     ...
     */
    protected boolean isConnected(BlockStateView world, BlockPos pos, Direction side, ConnectionDirection direction) {
     ...
     * @return True if the block can connect in the given ConnectionDirection, false otherwise.
     */
    protected boolean isConnected(BlockStateView world, BlockPos pos, Direction side, BlockState state, ConnectionDirection direction) {
     ...
     */
    protected boolean isConnected(BlockStateView world, BlockPos pos, BlockPos connection, Direction side) {
    ...
    protected boolean isConnected(BlockStateView world, BlockPos pos, BlockPos connection, Direction side, BlockState state) {
        ...
        if (disableObscuredFaceCheck.orElse(Config.CONFIG.connectInsideCTM)) {
            return true;
        }
    ...
    protected BlockState getConnectionState(BlockStateView world, BlockPos pos, BlockPos connection, @Nullable Direction side) {
