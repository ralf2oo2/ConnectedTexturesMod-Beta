...
public class TextureCTMV extends AbstractTexture<TextureTypeCTMV> {
    ...
    private ISubmap getUVs(Direction face1, Direction face2, TextureContextCTMV.Connections cons) {
        ISubmap uvs;
    ...
    private boolean blockConnectionY(Direction dir, TextureContextCTMV.ConnectionData data) {
        return blockConnection(dir, Axis.Y, data) || blockConnection(dir, dir.rotateClockwise(Axis.Y).getAxis(), data);
    }

    private boolean blockConnectionZ(Direction dir, TextureContextCTMV.ConnectionData data) {
        return blockConnection(dir, Axis.Z, data);
    }

    private boolean blockConnection(Direction dir, Axis axis, TextureContextCTMV.ConnectionData data) {
        Direction rot = dir.rotateClockwise(axis);
