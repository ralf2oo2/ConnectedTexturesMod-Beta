...
public class TextureMap extends AbstractTexture<TextureTypeMap> {
    ...
    public interface MapType {
        List<BakedQuad> transformQuad(TextureMap texture, BakedQuad bakedQuad, Direction cullFace, @Nullable TextureContext context);
    ...
    public enum MapTypeImpl implements MapType {
        RANDOM {
            @Override
            public List<BakedQuad> transformQuad(TextureMap texture, BakedQuad bakedQuad, Direction cullFace, @Nullable TextureContext context) {
