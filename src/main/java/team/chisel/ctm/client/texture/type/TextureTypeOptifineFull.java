...
import team.chisel.ctm.client.texture.TextureOptifineFull;
import team.chisel.ctm.client.texture.context.TextureContextConnecting;

public class TextureTypeOptifineFull implements TextureType {
    @Override
    public CTMTexture<TextureTypeOptifineFull> makeTexture(TextureInfo info) {
        return new TextureOptifineFull(this, info);
    }
